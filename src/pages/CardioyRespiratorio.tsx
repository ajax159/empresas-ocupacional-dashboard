...
import { CasosBradicardiaeTaquicardia, PrevalenciaHipertension, PromedioPresionArterial, ResultadosEspirometria } from '../components/features/cardioyrespiratoria';


export default function CardioyRespiratorio() {
