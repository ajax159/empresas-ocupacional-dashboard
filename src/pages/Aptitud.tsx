...
import { AptitudTrabajosAltura, CumplimientoExamenesPeriodicos, PorcentajeSeguimientoActivo, TrabajadoresInterconsulta } from '../components/features/aptitud';
    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <Grid container
                ...
                sx={{ mb: (theme) => theme.spacing(2) }}>
                <Grid size={{ xs: 12, md: 12 }}>
                    <CumplimientoExamenesPeriodicos />
                </Grid>
            </Grid>
            <Grid container
                spacing={2}
