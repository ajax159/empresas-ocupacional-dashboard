...
import { CasosHipoacusia, DistribucionHipoacusia, ExposicionRuido, PrevalenciaPresbicia, PrevalenciaPterigion } from '../components/features/visualyauditiva';


export default function VisualYAuditiva() {
